...
createApp({
        ...
        return {
            ...
            translations: {
                en: {
                    ...
                    dryer: {
                        dryerInstanceLabel: 'Dryer ACE Instance:',
                        status: 'Status',
                ...
                zh: {
                    ...
                    notifications: {
                        ...
                        feedAssistOn: '槽位 {index} 送料辅助已启用',
                        feedAssistOff: '槽位 {index} 送料辅助已禁用',
                        feedAssistAllOff: '所有槽位的送料辅助已禁用',
                        feedAssistAllOffError: '禁用送料辅助失败',
                        refreshStatus: '状态已刷新',
                        dryingComplete: '干燥周期完成！',
                        validation: {
                            tempRange: '温度必须在 20 到 55°C 之间',
                            durationMin: '时长至少为 1 分钟',
                            feedLength: '长度至少为 1 mm',
                            retractLength: '长度至少为 1 mm'
                        }
                    },
                    statusMap: {
                        ready: '就绪',
    ...
    mounted() {
        ...
        const savedLang = localStorage.getItem('ace_language');
    ...
    methods: {
        ...
        switchLanguage(lang) {
            if (this.translations[lang]) {
                ...
                // 可选：保存用户选择到 localStorage
                localStorage.setItem('ace_language', lang);
                // 刷新界面上的状态文本（t 方法会自动响应）
                this.showNotification(`语言已切换至 ${lang === 'zh' ? '中文' : 'English'}`, 'info');
            }
        },
